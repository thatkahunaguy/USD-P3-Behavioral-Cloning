...
def generator(samples, batch_size=32):
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        # TODO think about whether shuffling in generator makes sense?
        # does this make it possible to never get a reasonable number of images
        # from small representations of the track like the dirt patches the
        # trained model seems to be having problems with?
